...
class mpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        labels = ['Rx_Bits - Tx_Bits', 'Signal 2', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.signals_grid_layout_1.addWidget(self._qtgui_time_sink_x_1_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.signals_grid_layout_0.addWidget(self._qtgui_time_sink_x_0_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.received_grid_layout_2.addWidget(self._qtgui_time_raster_sink_x_0_win, 0, 0, 1, 1)
        for r in range(0, 1):
        ...
        self.connect((self.blocks_char_to_float_0_0, 0), (self.qtgui_time_raster_sink_x_0, 0))
