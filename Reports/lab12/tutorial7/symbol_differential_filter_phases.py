...
class symbol_differential_filter_phases(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.mmse_resampler_xx_0_2 = filter.mmse_resampler_ff(1.0/5.0*0, 1)
        self.mmse_resampler_xx_0_1_0 = filter.mmse_resampler_ff(1.0/5.0*4, 1)
        self.mmse_resampler_xx_0_1 = filter.mmse_resampler_ff(1.0/5.0*3, 1)
        self.mmse_resampler_xx_0_0 = filter.mmse_resampler_ff(1.0/5.0*2, 1)
        self.mmse_resampler_xx_0 = filter.mmse_resampler_ff(1.0/5.0, 1)
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.mmse_resampler_xx_0_1, 0))
        self.connect((self.fir_filter_xxx_0, 0), (self.mmse_resampler_xx_0_1_0, 0))
        self.connect((self.fir_filter_xxx_0, 0), (self.mmse_resampler_xx_0_2, 0))
        ...
        self.connect((self.mmse_resampler_xx_0, 0), (self.fir_filter_xxx_0_2_0, 0))
        self.connect((self.mmse_resampler_xx_0_0, 0), (self.fir_filter_xxx_0_2_0_0, 0))
        self.connect((self.mmse_resampler_xx_0_1, 0), (self.fir_filter_xxx_0_2_0_1_0, 0))
        self.connect((self.mmse_resampler_xx_0_1_0, 0), (self.fir_filter_xxx_0_2_0_1, 0))
        self.connect((self.mmse_resampler_xx_0_2, 0), (self.fir_filter_xxx_0_2, 0))
